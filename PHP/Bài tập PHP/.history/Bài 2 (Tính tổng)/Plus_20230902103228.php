...
<body>
    <div class="container">
        ...
        <form method="POST" action="TinhTong.php">
            <label for="txtSoNhat">Số thứ 1:</label>
            <input type="text" name="txtSoNhat" id="txtSoNhat" required>

            <label for="txtSoHai">Số thứ 2:</label>
            <input type="text" name="txtSoHai" id="txtSoHai" required>
